...
class EmployeeRegistration(models.Model):
    user_id = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="example3"
    )
    register_user_id = models.ForeignKey(
        User, related_name="example4", on_delete=models.CASCADE, null=True
    )
...
class Invitation(models.Model):
    ...
    status = models.CharField(
        max_length=10, choices=StatusChoice.choices, default=StatusChoice.WAITING
    )
    created_at = models.DateTimeField(auto_now_add=True)
...
class CompanyCustomer(models.Model):
    user_id = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="example5"
    )
    customer_user_id = models.ForeignKey(
        User, on_delete=models.CASCADE, null=True, related_name="example6"
    )
...
class Organisation(models.Model):
    ...
    expiry_date = models.DateField()
    organisation_category = models.ForeignKey(
        OrganisationCategory, on_delete=models.CASCADE
    )
    ...
    organisation_fields = MultiSelectField(
        choices=ORGANISATION_FIELDS, max_length=255, null=True, blank=True
    )
...
class Branches(models.Model):
    ...
    organisational_admin = models.ForeignKey(
        OrganisationalAdmin, on_delete=models.CASCADE, null=True
    )
    location_address = models.CharField(max_length=100)
...
class VisitorLog(models.Model):
    ...
    visitor_item_image = models.CharField(max_length=1000, blank=True, null=True)
